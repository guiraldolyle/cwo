...
class Po_model extends CI_Model
{
    ...
    public function loadPo($supId, $cusId)
    {
    ...
    {
        $query = $this->db->select('l.po_header_id, l.item_code, t.description, l.qty, l.uom, l.direct_unit_cost')
                          ->from('po_line l')
                          ->join('items t', 't.itemcode_loc = l.item_code', 'left')
