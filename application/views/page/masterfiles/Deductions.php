                                    ...
                                    <tbody>
                                        <tr ng-repeat="d in deductions" ng-cloak>
                                            ...
                                            <td class="text-center">
                                                <button ng-disabled="d.status == 0" class="btn bg-gradient-info btn-flat btn-sm" data-toggle="modal" data-target="#updateDeduction" ng-click="fetchDeductionData(d)"><i class="fas fa-pen-square"></i> Edit
                                                </button>
                                                <button ng-disabled="d.status == 0" class="btn bg-gradient-danger btn-flat btn-sm" ng-click="deactivateDeduction(d)"><i class="fas fa-times"></i> Deactivate
                                                </button>
                                            </td>
                                        </tr>
                                    </tbody>
