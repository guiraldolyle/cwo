                                    ...
                                    <tbody>
                                        <tr ng-repeat="i in items" ng-cloak>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn bg-gradient-warning btn-flat btn-sm">
                                                    <i class="fas fa-trash"></i> Reset Supplier Code
                                                </button> -->
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a href="#" class="dropdown-item" data-toggle="modal" data-target="#updateItemCode" ng-click="editItem(i)">
                                                            <i class="fas fa-pen-square"></i> Map Item</a>
                                                        <a href="#" class="dropdown-item" ng-click="deleteItem(i)">
                                                            <i class="fas fa-trash"></i> Delete</a>
                                                        <a href="#" class="dropdown-item">
                                                            <i class="fas fa-redo-alt"></i> Reset Supplier Code</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
