...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <!-- TRANSACTION TAB -->
                        <?php if ($this->session->userdata('userType') == 'Admin' || $this->session->userdata('userType') == 'Accounting' || $this->session->userdata('userType') == 'Manager' || $this->session->userdata('userType') == 'Supervisor' || $this->session->userdata('userType') == 'Section Head' || $this->session->userdata('userType') == 'LDI') : ?>
                            <li class="nav-item dropdown">
                                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>transactions/ProformaVersusCRF" class="dropdown-item"><i class="fas fa-file-alt"></i> Proforma-PI VS CRF</a></li>
                                    <li><a href="<?php echo base_url(); ?>transactions/ProformaVersusPI" class="dropdown-item"><i class="fas fa-file-alt"></i> Proforma VS PI (per Item)</a></li>
                                    <li><a href="<?php echo base_url(); ?>transactions/SOP" class="dropdown-item"><i class="fas fa-file-alt"></i> SOP</a></li>
                        ...
                        <?php if ($this->session->userdata('userType') == 'SOP' || $this->session->userdata('userType') == 'IAD') : ?>
                            <li class="nav-item dropdown">
                                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">
                                    <i class="fas fa-exchange-alt nav-icon"></i> Transactions
                                </a>
                        ...
                        <?php if ($this->session->userdata('userType') != 'Buyer-Purchaser') : ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>reports/ProformavCrfHistory" class="dropdown-item"><i class="fas fa-file-alt"></i> Proforma-PI VS CRF History</a></li>
